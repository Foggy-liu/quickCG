...
本 skill 在设计时参考了以下项目，**感谢老师的启发**。本 skill 与它们**没有代码层面的依赖关系**，是独立的完整 skill：

- **[quick-cognition（v1，原版）](https://github.com/)** — 单 SKILL.md 版本，本 skill 是其模块化重构（按事物类型分发到专属 mode）
- **[hv-analysis](https://github.com/)** — 多事物对比研究思路，启发了本 skill 内的"同类对比"维度
- **[khazix-writer](https://github.com/)** — 散文写作风格，启发了本 skill 抽象概念 essay 模式的设计思路（roadmap 中）

## 🆚 与这些 skill 的区别

| 维度 | 本 skill (quick-cognition-v2) | hv-analysis | khazix-writer |
|------|------------------------------|-------------|---------------|
| **核心目的** | 对**单个事物**建立深度认知地图 | 对**多个事物**做横向 + 纵向对比研究 | 用卡兹克风格写公众号长文 |
| **输入** | 1 个事物（具体技术/抽象概念等）| 1 个事物 + 多个同类/竞品 | 选题 + 素材 |
| **输出** | 结构化 HTML 认知报告（4 维 + 横纵交汇） | 横纵交汇 PDF 研究报告 | 公众号长文 |
| **风格** | 认知地图，结构化呈现 | 研究报告，叙事 + 对标 | 散文风格，"有见识的普通人在认真聊" |
| **适用场景** | 想深入了解一个技术/概念 | 想做竞品分析 / 深度研究 | 想写公众号文章 |
| **本 skill 不做的事** | A vs B 并列对比 / 公众号写作 | 单一事物深度认知 | 认知地图生成 |

> 💡 **如果你的需求是多事物对比** → 用 hv-analysis
> **如果你的需求是公众号长文** → 用 khazix-writer
> **如果你的需求是深度认识一个具体事物** → 用本 skill
